...
How to participate in Song of Heroic Lands — whether you're changing the system
itself, building on top of it, or maintaining the project's tooling. Start from the
repository's [CONTRIBUTING.md](../../CONTRIBUTING.md), which routes each audience to
the right guide:
...
- [API Docs Hosting](./api-docs-hosting.md) — how the generated API reference is
  published.
