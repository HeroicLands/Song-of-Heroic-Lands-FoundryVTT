...
// glob, `gitignore: true` (which covers the generated `build/` tree), and
// `CHANGELOG.md` — regenerated by `changeset version` in every repository
// here, so linting it reports on the generator.
//
