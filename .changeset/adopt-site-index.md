...
spaces, the collision-aware fallbacks, the type-scoped aliases, the
foreign-manifest merge and its short-form rule, and the per-page resolver
context.

What stays is how a page gets its address in the first place — the URL scheme,
the section a note is filed under, the developer-docs pass — which is genuinely
this site's rather than shared.
