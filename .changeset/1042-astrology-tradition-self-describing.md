...
- `builtin-traditions` now exposes the raw data as `builtinTraditionsData`; the system
  seeds it into `sohl.astrologyRegistry` at init, validating once at registration
  rather than validating twice.
