 ...
 *
 * `assets/content/` is generated by `utils/export-vault-content.mjs`, so an
 * empty tree is a real possibility (an export never run, or run against the
 * wrong path). This counts what is actually there so the build can refuse.
 */
