...
| **Break Ties**             | Opposed tests only, and only for the side starting one. Off by default; ticked, a tied contest is settled instead of reported as a tie — see [[Token]] |
