...
exposure — see [[Being]]), a drag from a compendium of written-up
...
open the affliction and use its **Actions** tab. See [[Actions]] for how
...
- [[Being]] — **Contagion Check** and **Contagion Test**, the exposure roll that starts most
