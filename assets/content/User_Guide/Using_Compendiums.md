...
Compendiums are pre-built libraries of actors, items, and journal entries
that come with SoHL. They contain ready-to-use characters, creatures,
...
- **Don't modify compendium originals.** Always work with imported copies
  in your world. Compendium content may be updated when SoHL is updated.
- **Use Basic Folk as a template.** Import it, duplicate it, and customize
