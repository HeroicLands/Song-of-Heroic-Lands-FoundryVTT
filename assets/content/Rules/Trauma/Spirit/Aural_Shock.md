...
— the aura torn loose from what anchors it. It is the characteristic harm of the
mystical world: the backlash of a working that went wrong, the wound left by a
hostile spirit, the price of touching something that should not have been
touched. The body is untouched; what is hurt is the part of the character that
reaches beyond it.

Each instance is rated **1–6**, and levels from multiple sources **stack into one
running total**. A character carrying Aural Shock is not injured, not tired, and
not frightened — they are simply, for the moment, cut off.
...
If circumstances **compel** such a test — the character is targeted by a spell or
an artifact and something must be rolled — the result is an automatic **Critical
Failure**.
...
This is what makes Aural Shock the one trauma every practitioner fears above
wounds. A wounded mystic can still work; a shocked one cannot work at all. And
because Fate answers through the same aura, there is no spending a point to
escape it: the way out is recovery, and only recovery.

## Aural Shock Recovery Test {#recovery-test}

Recovery is a **Will** test made **once per day**; fatigue and impairment
