...
The Healing Test is made against Heal Base (HB) × HR, so a character with HB 14
and HR 4 rolls against an EML of 56.

**An untreated injury has no Healing Rate**, and therefore nothing to roll
against. Every Healing Test on such an injury is an
**automatic Critical Failure** — no dice are rolled. The injury makes no
progress for as long as it goes untreated, and takes the Critical Failure
consequences each period, including infection.
