...
(not applicable), and a Healing Rate of
...
Because the interval is d10 days and each roll moves the rate by one or two, a
coma is a matter of weeks, not turns. Nothing about it is decided at the table in
a hurry, and a comatose character is cared for or abandoned by the people around
them long before the last Course Roll is made.
