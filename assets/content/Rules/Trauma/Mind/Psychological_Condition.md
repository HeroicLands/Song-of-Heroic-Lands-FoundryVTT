...
The victim makes a **Psyche Stress Recovery Test** for each PSY of a condition,
**every d6 days**. Fatigue does not affect the test.
...
An indefinite condition goes away — the victim recovers — when its PSY reaches
**0 or less**.

## Behavioral effects

Whenever a character suffers Psyche Stress, they acquire an **indefinite
psychological condition** whose intensity is measured in PSY levels. It does not
...
An Impulse or Disorder demands a **Will** test whenever it is triggered; on
failure the condition expresses itself. An expressed condition lasts while the
