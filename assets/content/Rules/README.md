...
- [[Opposed_Tests|Opposed Success Tests]] — when two characters act against each other. Both test simultaneously; the highest success level wins. Victory Stars measure the margin.
...
- [[rules/sohl-fate|Fate]] — spending a Fate Point _after_ a roll to raise its success level (never a re-roll). Points are held through Fate Mysteries, general or skill-specific.
- [[Body_Structure|Body Structure]] — the three-tier anatomy (body zones, body parts, and body locations) that governs where blows land, how armor protects, and how injuries impair function. Includes body roles, Zone Number and Zone Die hit-location resolution, Shock Value, and how parts become impaired or unusable.
...
- [[rules/sohl-arcane|Arcane]] — power from the caster's own aura and taught lore: the Birthsign, the Fate mystery, and the Arcane Incantation, Arcane Talent, Alchemy, and Divination abilities.
