...
[[doc-architecture|Prime Directive]] — _assist, never play the game_ — structural
...
See also: [[doc-macrosandactions|Macros and Actions]],
[[doc-securitymodel|Security Model & Guardrails]],
[[doc-combatmodel|Combat Model]].
...
## Self-sufficient actions {#self-sufficient-actions}
...
[[doc-securitymodel|Security Model]]).
