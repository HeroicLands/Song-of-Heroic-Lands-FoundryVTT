...
data is untrusted (see the [[doc-securitymodel|Security Model]]), so the system
...
[[doc-securitymodel#extension-points-which-tool-for-which-need|extension-point matrix]]
...
[[doc-securitymodel#why-not-a-sandbox-denylist|security model]]).
...
### Adding a call site: declaring its scope {#adding-a-call-site-declaring-its-scope}
...
### The standard helpers {#the-standard-helpers}
...
**Time** _(read the live clock — mainly for [[doc-eventqueue|event-queue]]
...
[[doc-macrosandactions|Script action]]'s `executor` is the **UUID of a Macro**,
...
[[doc-macrosandactions|Macros and Actions]] and the security model's
[[doc-securitymodel#gm-homebrew-use-foundry-macros-not-a-bespoke-sandbox|GM-homebrew section]].
...
way — see [[doc-extensionpoints|Extension Points]].
...
`textToFunction` — see the [[doc-securitymodel#the-core-principle-reference-code-never-compile-it-from-data|security model]].

## See also

- [[doc-macrosandactions|Macros and Actions]] — macros vs. document-attached actions.
- [[doc-securitymodel|Security Model & Guardrails]] — why these mechanisms are shaped this way.
- [[doc-effectsintegration|Effects Integration]] — where effect predicates use SafeExpression.
