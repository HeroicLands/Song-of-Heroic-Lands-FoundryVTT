...
See also: [[doc-combatresolutionpipeline|Combat Resolution Pipeline]]
(the result classes and opposed-test math), [[doc-scenetokencombatant|Scene, Token, and Combatant Systems]] (the combatant model),
[[doc-macrosandactions|Macros and Actions]], and the player-facing
[[doc-cmbtbscsug|Combat Basics]] guide.
...
`SuccessTestResult` (see the [[doc-combatresolutionpipeline|pipeline doc]]).
...
### Combatant groups {#combatant-groups}
...
- [[doc-combatresolutionpipeline|Combat Resolution Pipeline]] — the
  result-class hierarchy, opposed-test math, victory score, tactical advantages,
  and injury resolution.
- [[doc-scenetokencombatant|Scene, Token, and Combatant Systems]] —
  token/targeting helpers, initiative, movement state.
- [[doc-bodystructure|Body Structure]] — hit location and armor
  aggregation.
- [[doc-macrosandactions|Macros and Actions]] — how intrinsic actions (the
