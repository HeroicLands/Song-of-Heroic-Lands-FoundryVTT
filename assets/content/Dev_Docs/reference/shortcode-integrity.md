...
See also: [[doc-runtimecontracts|Runtime Contracts]], [[doc-extensionpoints|Extension Points]], [[doc-systemdevelopment|System Development]]
...
[[doc-contentlinks|Linking Between Content Notes]]); the same key also has to survive
...
[[doc-contentlinks|Linking Between Content Notes]] — and a note
...
The developer documentation (`assets/content/Dev_Docs/`) is content: each page
is a `doc` note with a shortcode of its own, addressed `doc-<shortcode>`, and
`pack: none` keeps it out of every compendium.
