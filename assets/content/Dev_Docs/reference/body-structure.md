...
## Laterality and dominance {#laterality-and-dominance}
...
see [[doc-combatresolutionpipeline|Combat Resolution Pipeline]]) is resolved by a
...
[[doc-extensionpoints#adding-a-graded-special-result-test-pass-data-dont-subclass|graded-test-as-data recipe]]
...
The Human body structure is the reference anatomy shipped today — carried on the [[being-basicfolk|Basic Folk]] being's `system.body.structure` (authored in `assets/content/Characters/Basic_Folk.md`). Its structure:
