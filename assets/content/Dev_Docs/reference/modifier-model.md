...
See also: [[doc-combatresolutionpipeline|Combat Resolution Pipeline]], [[doc-extensionpoints|Extension Points]].
...
and the change sits _below_ the [[doc-resultdescriptiontables|`resultDescTable`]]
...
Player-facing rule: [[doc-fatepnts|Fate Points]] in the rules (source: `assets/content/Rules/Resolution/Fate_Points.md`).
