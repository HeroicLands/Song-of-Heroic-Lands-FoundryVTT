...
(per-document state and actions). See **[[doc-sohlapi|The SoHL API]]**
for both surfaces and the `SohlSystem` member reference, and
[[doc-apiaccessmap#reaching-sohl-at-runtime|API Access Map]] for how a
...
or other items uniformly across all documents. See [[doc-lifecyclehooks|Lifecycle Hooks]]
...
### Scheduling deferred actions {#scheduling-deferred-actions}
...
That is the [[doc-devdocs|Prime Directive]] in mechanism form —
...
[[doc-macrosandactions|Macros and Actions]]; never inline code into
...
[[doc-cssarchitecture|CSS Architecture & Styleguide]].
...
standalone module), see [[doc-systemdevelopment|System Development]].
