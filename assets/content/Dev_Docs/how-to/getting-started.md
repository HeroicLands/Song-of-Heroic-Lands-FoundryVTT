...
See also: [[doc-architecture|Architecture Overview]], [[doc-extensionpoints|Extension Points]], [[doc-expressions|Expressions and Scripts]], [[doc-securitymodel|Security Model]].
...
1. **[[doc-architecture|Architecture Overview]]** — the mental model. Read this first.
...
See [[doc-extensionpoints#2-actor-and-item-type-extension|Extension Points — Item type extension]] for the full checklist.
...
See [[doc-testing|Testing Guide]] for the full setup.
...
User guide content is authored **in this repository** as Markdown under `assets/content/` (frontmatter `type: doc`), and compiled into Foundry journal entries during build (see [[doc-buildanddeployment#5-compendium-packs-from-in-repo-markdown|Build & Deployment §5]]). It is source, not generated output: **edit it here**.

## Where to find things

| I want to...                      | Look at...                                              |
| --------------------------------- | ------------------------------------------------------- |
| Understand the architecture       | [[doc-architecture             \| Architecture]]        |
| See all actor/item types          | [[doc-typecatalog              \| Type Catalog]]        |
| Understand how values are tracked | [[doc-modifiermodel            \| Modifier Model]]      |
| Understand combat resolution      | [[doc-combatresolutionpipeline \| Combat Pipeline]]     |
| Understand hit locations          | [[doc-bodystructure            \| Body Structure]]      |
| Add house rules via module        | [[doc-lifecyclehooks           \| Lifecycle Hooks]]     |
| Add per-item behavior             | [[doc-macrosandactions         \| Macros and Actions]]  |
| Write tests                       | [[doc-testing                  \| Testing]]             |
| Understand active effects         | [[doc-effectsintegration       \| Effects Integration]] |
