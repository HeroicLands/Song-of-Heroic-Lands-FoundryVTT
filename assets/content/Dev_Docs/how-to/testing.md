...
See also: [[doc-architecture|Architecture Overview]], [[doc-extensionpoints|Extension Points]]
...
createRng(...))`) — isolated and order-independent. In e2e, re-seed the shared
  ...
  still win over a seeded generator. See [[doc-randomness|Randomness]],
...
The [[doc-actioncards|consent model]] means SoHL constantly surfaces
...
2. **Pre-answer / suppress — for setup, when the dialog is _incidental_.** When you
   ...
   [[doc-actioncards|prefer-dialog rule]]) —
