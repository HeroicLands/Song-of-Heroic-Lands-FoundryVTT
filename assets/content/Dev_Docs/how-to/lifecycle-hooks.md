...
[[doc-houserulescookbook#recipe-2-apply-a-rule-to-many-spells-module|House Rules Cookbook — Recipe 2]].
...
[[doc-houserulescookbook#recipe-3-the-recommended-guard-pattern|House Rules Cookbook — guard pattern]].

## See also

- [[doc-macrosandactions|Macros and Actions]] — per-item behavior instead of type-wide.
- [[doc-extensionpoints|Extension Points]] — choosing an extension scope.
- {@link sohl.core.logic.SohlLogic} — the phase model and rationale.
- [[doc-moduledevelopment|Writing Modules]] — building the module these hooks live in.
