...
See also: [[doc-devdocs|Documentation]], [[doc-extensionpoints|Extension Points]]
...
3. Set the action's `scope` (`SELF` / `ITEM` / `ACTOR`) and, if needed,
   ...
   [[doc-securitymodel|`SafeExpression`]] string).
...
## Recipe 2: Apply a rule to many spells (Module) {#recipe-2-apply-a-rule-to-many-spells-module}
...
## Recipe 3: The recommended guard pattern {#recipe-3-the-recommended-guard-pattern}
...
- [[doc-macrosandactions|Macros and Actions]] — authoring macros and Script Actions
- [[doc-lifecyclehooks|Lifecycle Hooks (Developer Guide)]] — complete hook name reference for module authors
- [[doc-extensionpoints|Extension Points (Developer Guide)]]
