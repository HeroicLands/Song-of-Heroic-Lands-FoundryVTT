![Song of Heroic Lands](./sohl-background.webp)
...
- **[Architecture Overview](https://www.heroiclands.org/sohl/doc-architecture/)**
  (Knowledgebase) — the mental model and a map of the `src/` tree. Read this first.
- **[Getting Started](https://www.heroiclands.org/sohl/doc-gettingstarted/)**
