describe("DefendResult", () => {
    ...
    describe("evaluate()", () => {
        ...
        it.todo(
            "adds FUMBLE_TEST mishap for block/counterstrike critical failure with lastDigit 0",
        );
        it.todo(
            "adds STUMBLE_TEST mishap for block/counterstrike critical failure with lastDigit 5",
        );
