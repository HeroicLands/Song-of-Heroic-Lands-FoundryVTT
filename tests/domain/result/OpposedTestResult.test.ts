describe("OpposedTestResult", () => {
    describe("constructor", () => {
        ...
        it.todo(
            "throws when neither targetTestResult nor targetToken is provided",
        );
        it.todo("creates instance with sourceTestResult and targetTestResult");
        it.todo(
            "creates a default SuccessTestResult for target when only targetToken is provided",
        );
    ...
    describe("isTied", () => {
        it.todo(
            "returns true when both succeed at the same level and neither both-fail",
        );
    ...
    describe("sourceWins", () => {
        it.todo(
            "returns true when source normSuccessLevel > target normSuccessLevel",
        );
        it.todo("returns false when both fail");
    ...
    describe("targetWins", () => {
        it.todo(
            "returns true when target normSuccessLevel > source normSuccessLevel",
        );
        it.todo("returns false when both fail");
