...
export const {
    ...
    OPPOSEDTESTSTART: {
        ...
        iconClass: "fa-solid fa-arrow-down-left-and-arrow-up-right-to-center",
        condition: "true",
        group: SOHL_CONTEXT_MENU_SORT_GROUP.ESSENTIAL,
    },
    SHOCKTEST: {
        id: "shockTest",
        name: "Shock Test",
        iconClass: "fa-regular fa-face-eyes-xmarks",
        condition: "true",
        group: SOHL_CONTEXT_MENU_SORT_GROUP.GENERAL,
    },
    STUMBLETEST: {
    ...
    FATIGUETEST: {
        id: "fatigueTest",
        name: "Fatigue Test",
        iconClass: "fa-solid fa-face-downcast-sweat",
        condition: "true",
        group: SOHL_CONTEXT_MENU_SORT_GROUP.GENERAL,
    },
    TREATMENTTEST: {
    ...
    AUTOCOMBATMISSILE: {
        ...
        iconClass: "fa-solid fa-bow-arrow",
        condition: "true",
        group: SOHL_CONTEXT_MENU_SORT_GROUP.ESSENTIAL,
    },
    MISSILEATTACK: {
