...
import { BodyZoneData } from "@logic/common/item/data";
...
export class BodyZoneDataModel
    extends SohlItemDataModel<BodyZonePerformer>
    implements BodyZoneData
{
    protected static readonly logicClass = BodyZonePerformer;
    declare readonly parent: SohlItemProxy<BodyZonePerformer>;
    abbrev!: string;
