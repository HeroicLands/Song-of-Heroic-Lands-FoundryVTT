...
import { MiscGearData } from "@logic/common/item/data";
import { MiscGearPerformer } from "@logic/common/item/performer";
    ...
    implements MiscGearData
{
    ...
    declare readonly parent: SohlItemProxy<MiscGearPerformer>;
}
