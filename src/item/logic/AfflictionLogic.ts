...
import type { InjuryData } from "@src/item/logic/InjuryLogic";
import {
    ACTION_SUBTYPE,
...
import { SohlItemBaseLogic, SohlItemData } from "@src/item/foundry/SohlItem";
import { serializeFn } from "@src/utils/helpers";
import { ActionData } from "@src/item/logic/ActionLogic";
